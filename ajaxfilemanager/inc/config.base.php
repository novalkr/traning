...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../tinymce/files/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../tinymce/files/');	//accept relative path only
	...
	define('CONFIG_SYS_EXC_FILE_PATTERN', '.gitignore'); //will prevent listing of files with such pattern(s). separated by , if multiple
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,zip,rar,xls,xlsx,pdf'); // 
