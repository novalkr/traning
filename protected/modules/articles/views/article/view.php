...
<?php
    ...
    Yii::app()->getClientScript()->registerLinkTag(
        "canonical", 
        null,
        $this->createAbsoluteUrl('/articles/article/view', array('id' => $article->id))
    );
?>
...
?>
Это работает
<?php if (isset($revision->main_media_object_id)) : ?>
    ...
    <?php /*
            ...
            */
            ...
            <div id="main_foto">
            <img src=
                "<?php echo $revision->getMainPhotoUrl(
                    YArticleController::MAIN_PHOTO_GROUP,
                    YArticleController::MAIN_PHOTO_FORMAT_MEDIUM) 
                ?>" 
...
<?php
<div class="publ-date">
    <b><?php echo Yii::t('articles', 'Date of publication'); ?>:</b> <?php echo $revision->create_time; ?>
</div>
*/
?>
